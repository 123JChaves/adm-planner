...
const Menu = () => {
    ...
    return (
        <div className="bg-blue-700 text-white p-4 w-full">
            <div className="max-w-6x1 mx-auto flex items-center">
                <h2 className="text-xl font-bold"><Link href="/">Logos</Link></h2>
                <ul className="flex space-x-6 ml-6">
                    <li><Link href="/users/list" className="hover:text-gray-300">Usuários</Link></li>
                    <li><Link href="/users/create" className="hover:text-gray-300">Cadastro</Link></li>
